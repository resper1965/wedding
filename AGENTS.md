...
## Repository map
- `bun.lock/` — explain what lives here and when agents should edit it.
...
- `download/` — explain what lives here and when agents should edit it.
- `eslint.config.mjs/` — explain what lives here and when agents should edit it.
- `examples/` — explain what lives here and when agents should edit it.
- `firebase/` — explain what lives here and when agents should edit it.
- `firebase.json/` — explain what lives here and when agents should edit it.
