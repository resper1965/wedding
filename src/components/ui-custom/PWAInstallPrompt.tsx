...
export function PWAInstallPrompt() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="rounded-2xl border border-amber-200/60 bg-white/98 p-4 shadow-xl backdrop-blur-md">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-amber-50">
              <Heart className="h-5 w-5 text-amber-600" fill="currentColor" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-stone-800">Instalar o app</p>
              ...
              <div className="mt-3 flex gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-amber-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-amber-700 active:bg-amber-800"
                >
