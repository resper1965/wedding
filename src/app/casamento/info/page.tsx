...
const giftLists = [
  ...
  },
  {
    ...
    icon: CreditCard,
    url: '#',
    pixKey: 'contato@marryflow.com.br'
  }
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-12 sm:py-16">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -right-32 -top-32 h-64 w-64 rounded-full bg-gradient-to-br from-primary/10 to-primary/5 blur-3xl" />
          <div className="absolute -bottom-32 -left-32 h-64 w-64 rounded-full bg-gradient-to-br from-accent/10 to-primary/5 blur-3xl" />
        </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="mb-2 text-xl font-medium text-foreground">Dress Code</h2>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="rounded-xl border border-accent/20 bg-accent/5 p-3">
                    ...
                    <p className="mt-1 text-xs text-accent/70">Branco, off-white, tons muito claros</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <div className="mb-6 flex items-center justify-center gap-2">
              <Gift className="h-5 w-5 text-accent" />
              <h2 className="text-xl font-medium text-primary font-serif">Lista de Presentes</h2>
            </div>
                    ...
                    {list.pixKey ? (
                      <div className="space-y-2">
                        <div className="rounded-lg border border-border bg-muted/30 p-3">
                          <p className="text-xs text-foreground/50">Chave PIX:</p>
                          <p className="font-mono text-sm text-primary">{list.pixKey}</p>
                        </div>
                        <Button
                          variant="outline"
                          size="sm"
              ...
              <Accordion type="single" collapsible className="space-y-2">
                {faqs.map((faq, index) => (
                  <AccordionItem
                    key={index}
                    value={`item-${index}`}
                    className="border-b border-border/50 px-4 last:border-0"
                  >
                    <AccordionTrigger className="text-left text-foreground/80 hover:text-primary [&[data-state=open]]:text-primary font-serif">
                      {faq.question}
                    </AccordionTrigger>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <div className="mb-6 flex items-center justify-center gap-2">
              ...
              <h2 className="text-xl font-medium text-primary font-serif">Contato</h2>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-gradient-to-br from-primary/5 to-accent/5 p-6 sm:p-8">
              <div className="grid gap-6 sm:grid-cols-3">
                <div className="text-center">
                  ...
                  <a href="mailto:contato@marryflow.com.br" className="text-sm text-primary hover:underline">
                ...
                <div className="text-center">
                  ...
                  <a href="tel:+5511999999999" className="text-sm text-primary hover:underline">
                    (11) 99999-9999
                  </a>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-primary">{wedding?.venue || 'Espaço Jardim Secreto'}</p>
                </div>
              </div>
            </div>
          </motion.div>
